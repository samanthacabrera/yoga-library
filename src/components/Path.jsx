...
const PathQuiz = () => {
  ...
  const questions = [
    {
      question: "What does 'Yama' refer to in the 8-Limbed Path of Yoga?",
      options: [
        { value: 'A', text: 'Physical postures' },
        { value: 'B', text: 'Breath control' },
        { value: 'C', text: 'Ethical practices' },
        { value: 'D', text: 'Meditative concentration' }
      ],
      correctAnswer: 'C'
    },
    {
      question: "Which of the following is a key aspect of 'Pranayama'?",
      options: [
        { value: 'A', text: 'Withdrawal of senses' },
        { value: 'B', text: 'Control of breath' },
        { value: 'C', text: 'Physical strength and flexibility' },
        { value: 'D', text: 'Self-reflection through meditation' }
      ],
      correctAnswer: 'B'
    },
    {
      question: "What does the limb 'Dharana' focus on?",
      options: [
        { value: 'A', text: 'Sensory withdrawal' },
        { value: 'B', text: 'Concentration on a single point' },
        { value: 'C', text: 'Physical endurance' },
        { value: 'D', text: 'Deep meditation' }
      ],
      correctAnswer: 'B'
    },
    {
      question: "Which practice helps in turning the senses inward to create mental clarity?",
      options: [
        { value: 'A', text: 'Dhyana' },
        { value: 'B', text: 'Asana' },
        { value: 'C', text: 'Pratyahara' },
        { value: 'D', text: 'Yama' }
      ],
      correctAnswer: 'C'
    },
    {
      question: "Which limb of yoga is considered the ultimate state of union and bliss?",
      options: [
        { value: 'A', text: 'Samadhi' },
        { value: 'B', text: 'Niyama' },
        { value: 'C', text: 'Asana' },
        { value: 'D', text: 'Pranayama' }
      ],
      correctAnswer: 'A'
    }
  ];
