...
const Drawer = () => {
  ...
  return (
    <div className="fixed top-0 left-0 h-full flex items-center z-50">
      ...
      >
        <Link to="/" className="text-center rounded-lg p-1 my-4 bg-white opacity-90 hover:opacity-100 transition-all duration-300 ease-in-out">Learn Yoga Online</Link>
        {[
